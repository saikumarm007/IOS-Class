...
class ViewController: UIViewController {
    ...
    var arr = [["actor1","actor2","actor3","actor4","actor5"],["book1","book2","book3","book4","book5"],["animal1","animal2","animal3","animal4","animal5",]]
